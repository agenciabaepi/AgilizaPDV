-- Cashback: colunas em vendas, forma CASHBACK, tabelas de carteira e regras.
...
-- Mesmo conjunto de formas que 006 (evita falha se já houver A_PRAZO no Postgres antes do 006 rodar).
