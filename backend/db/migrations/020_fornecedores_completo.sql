...
-- Dados principais
ALTER TABLE fornecedores ADD COLUMN tipo_cadastro TEXT NOT NULL DEFAULT 'J' CHECK (tipo_cadastro IN ('F','J'));
...
ALTER TABLE fornecedores ADD COLUMN indicador_contribuinte TEXT DEFAULT '9' CHECK (indicador_contribuinte IN ('1','2','9'));
...
ALTER TABLE fornecedores ADD COLUMN updated_at TEXT DEFAULT (datetime('now'));
