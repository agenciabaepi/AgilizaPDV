-- Fornecedores - cadastro completo (SQLite / pdv.db no Windows e Mac)
-- NÃO rode este arquivo no Supabase — use docs/supabase-fornecedores-migracao.sql lá.

-- Dados principais (sem CHECK na mesma linha do ADD COLUMN — compatível com SQLite)
...
-- SQLite não aceita DEFAULT com função em ADD COLUMN
